...
# # Download ROIs
for sub in [1,2,5,7]:
    os.system('aws s3 cp --recursive s3://natural-scenes-dataset/nsddata/ppdata/subj{:02d}/func1pt8mm/roi ./data/nsddata/ppdata/subj{:02d}/func1pt8mm/roi/'.format(sub,sub))